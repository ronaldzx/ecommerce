...
class appProdProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('7sJDsqS+2t', 0, ($this->targetDirs[0].'/pools'));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => 'tuquidelivery.com', 'port' => '', 'dbname' => 'tuquidel_ecommerce', 'user' => 'tuquidel', 'password' => 'Tuqui2020@', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.0999999999999996447286321199499070644378662109375, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_ba704e0a3e9fd50cd2d66b2054f0f5f7e6ffa62b193057c250b831a9d4416951');
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('MeU19Uq2w0pBzC7D09nsOAqVCDkS40FAXTaj9ZeoaeLXDWYNzn2JtgUX'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('MeU19Uq2w0pBzC7D09nsOAqVCDkS40FAXTaj9ZeoaeLXDWYNzn2JtgUX');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_host' => 'tuquidelivery.com',
            'database_port' => '',
            'database_name' => 'tuquidel_ecommerce',
            'database_user' => 'tuquidel',
            'database_password' => 'Tuqui2020@',
            'database_prefix' => 'ps_',
            ...
            'kernel.secret' => 'MeU19Uq2w0pBzC7D09nsOAqVCDkS40FAXTaj9ZeoaeLXDWYNzn2JtgUX',
